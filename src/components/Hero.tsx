  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-4xl px-[27px] py-0 mx-0 my-0">
        <div className="mb-3 animate-fade-in">
          <img src="/lovable-uploads/59c6ac5c-6034-4d59-a754-24b5a8b6762c.png" alt="Mariah Studio - Beleza e Estética" className="mx-auto max-w-sm w-full h-auto" />
        </div>
        ...
        <Button onClick={handleWhatsAppClick} className="bg-premium-gold hover:shadow-2xl text-white font-bold px-10 py-6 text-lg rounded-full shadow-2xl transform hover:scale-110 transition-all duration-300 border-2 border-gold-light">
